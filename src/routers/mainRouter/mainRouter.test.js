...
describe("Testing engine (youtube, sc) endpoints", () => {
  const password = getRandomCode();
  const user = {
    username: "userRouterName",
    email: "engineTest@test",
    password,
    history: [],
    favourites: [],
  };
  ...
  it("should return results for youtube search", (done) => {
    agent
  ...
  it("should return results for soundcloud search", (done) => {
    agent
  ...
  it("should return array of string suggestions for youtube when given string", (done) => {
    agent
  ...
  it("should return array of string suggestions for soundcloud when given string", (done) => {
    agent
  ...
  it("should return direct url when given item id (youtube)", (done) => {
    agent
  ...
  it("should return direct url when given item id (soundcloud)", (done) => {
    agent
  ...
  it("should return playlist items when given youtube playlist Id", (done) => {
    agent
  ...
  it("should return channel playlists when given youtube channel Id", (done) => {
    agent
